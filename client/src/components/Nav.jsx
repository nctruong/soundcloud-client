...
const Nav = state => (
  <nav id="main-nav">
    ...
    <ul>
      ...
      <li className="social-navlinks"><a href="#" target="_blank"><i className="fab fa-2x fa-twitter"></i></a></li>
      <li className="social-navlinks"><a href="#" target="_blank"><i className="fab fa-2x fa-linkedin"></i></a></li>
      <li className="social-navlinks"><a href="#" target="_blank"><i className="fab fa-2x fa-github"></i></a></li>
    </ul>
  </nav>
)
export default Nav;
